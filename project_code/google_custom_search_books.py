...
class search:
	def search_books(self,search_query):
		...
		data=" "
		try:
			data = urllib2.urlopen('https://www.googleapis.com/customsearch/v1?key=AIzaSyDPc6ocjFyiddxMc_pQNxGtnDM-P8634NU&cx=008016317575559464792:m0_rq_ajn8g&q='+search_query+'&highrange=1&start=1')
			data = json.load(data)
...
#obj=search()
#result=obj.search_books("deception point")
